...
class ProductosViewSerializer(ma.SQLAlchemyAutoSchema):
    class Meta:
        model=productos_view
        fields=('id','name','photo_product')
        
productoview_schema=ProductosViewSerializer()
productosview_schema=ProductosViewSerializer(many=True)  
